...
const slides = [
  {
    ...
    title: "Temukan penginapan terbaik sesuai cara liburanmu",
    body: "Cari hotel, villa, dan homestay pilihan dengan alur yang ringkas, rapi, dan lebih mudah dipercaya.",
    points: ["Pencarian cepat", "Harga lebih jelas", "Booking terasa ringan"],
    previewTitle: "Destinasi populer",
    previewMeta: "Bali • Yogyakarta • Lombok",
  ...
  },
  {
    ...
    title: "Jelajahi tempat unik dengan kurasi yang terasa premium",
    body: "Setiap Hidden Gem hadir dengan cerita singkat, suasana tempat, dan detail penting yang membuat pilihan terasa lebih meyakinkan.",
    points: ["Kurasi editorial", "Visual aspiratif", "Nilai beda terasa"],
    previewTitle: "Unggulan minggu ini",
    previewMeta: "View sawah • Sarapan lokal • Rating 4.9",
  ...
  },
  {
    ...
    title: "Info ramah Muslim hadir natural di setiap perjalanan",
    body: "Arah kiblat, kuliner halal, dan tempat ibadah terdekat ditampilkan tanpa membuat pengalaman terasa rumit.",
    points: ["Lebih inklusif", "Info sekitar jelas", "Siap check-in"],
    previewTitle: "Info sekitar tersedia",
    previewMeta: "Masjid • Kuliner halal • Arah kiblat",
